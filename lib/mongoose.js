...
module.exports = app => {
    ...
    conn.on('connected', () => {
        ...
        // var News = conn.model('News', newsSchema);
        ...
        // News.find(function (err, kittens) {
        //     if (err) return console.error(err);
        //     console.log(kittens);
        // });
    ...
    conn.once('open', () => {
        //    news.find({}, function (err, a) {
        //         conosle.log(12321312);
        //         console.log(err);
        //    });
        app.coreLogger.info(`[egg-mongoose] ${config.url} open successfully`);
    });
