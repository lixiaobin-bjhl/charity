...
{% block css %}
     <link rel="stylesheet" href="/public/scripts/home_d41d8cd98f.css"/>
{% endblock %}
...
{% block layoutContainer %}
    ...
    <div class="rollpic" style="min-height: 50px;">
        <div data-am-widget="slider" height="100" class="am-slider am-slider-default" data-am-slider='{}' >
            <ul class="am-slides">
                <li><img src="public/img/hw_bg3_ffdc583269.jpg"/></li>
  ...
  am-avg-md-4 am-avg-lg-4 am-gallery-bordered customer-case-content" >
      <li class="case-li am-u-sm-6 am-u-md-6 am-u-lg-3">
        <div class="am-gallery-item case-img1">
            <a href="#" >
              <img src="public/img/app1_d047f158f0.png"  />
      ...
      <li class="case-li am-u-sm-6 am-u-md-6 am-u-lg-3">
        <div class="am-gallery-item case-img1">
            <a href="#" >
              <img src="public/img/app2_901e829d7f.png"  />              
            </a>
        </div>
        <div class="case-li-mengban">
        	<div class=" case-word">
      ...
      <li class="case-li am-u-sm-6 am-u-md-6 am-u-lg-3">
        <div class="am-gallery-item case-img1">
            <a href="#" >
              <img src="public/img/app3_717bc9427e.png"  />             
            </a>
        </div>
        <div class="case-li-mengban">
        	<div class=" case-word">
      ...
      <li class="case-li am-u-sm-6 am-u-md-6 am-u-lg-3">
        <div class="am-gallery-item case-img1">
            <a href="#" >
              <img src="public/img/app4_f7299acf44.png"  />             
            </a>
        </div>
        <div class="case-li-mengban">
        	<div class=" case-word">
      ...
      <li class="case-li am-u-sm-6 am-u-md-6 am-u-lg-3">
        <div class="am-gallery-item case-img1">
            <a href="#" >
              <img src="public/img/app5_6703e3cdc8.png"  />              
            </a>
        </div>
        <div class="case-li-mengban">
        	<div class=" case-word">
      ...
      <li class="case-li am-u-sm-6 am-u-md-6 am-u-lg-3">
        <div class="am-gallery-item case-img1">
            <a href="#" >
              <img src="public/img/app6_715bf4ae86.png"  />                
            </a>
        </div>
        <div class="case-li-mengban">
        	<div class=" case-word">
      ...
      <li class="case-li am-u-sm-6 am-u-md-6 am-u-lg-3">
        <div class="am-gallery-item case-img1">
            <a href="#" >
              <img src="public/img/app7_52c7da77bd.png"  />                
            </a>
        </div>
        <div class="case-li-mengban">
        	<div class=" case-word">
      ...
      <li class="case-li am-u-sm-6 am-u-md-6 am-u-lg-3">
        <div class="am-gallery-item case-img1">
            <a href="#" >
              <img src="public/img/app8_806649685e.png"  />               
            </a>
        </div>
        <div class="case-li-mengban">
        	<div class=" case-word">
...
{% block script %}
<script src="/public/scripts/home_dc43bd333f.js"></script>
{% endblock %}
